...
SYSTEM_PROMPT_INQUIRY = """
    ...
    8. 特定の部署の従業員一覧を求められた場合、提供された文脈に含まれるすべての該当者を漏れなく表示してください。各従業員の情報は表形式で整理し、最低でも氏名、部署、役職を含めて表示してください。複数の文脈に同じ部署の異なる従業員が含まれている場合は、すべてを統合して一つの包括的なリストを作成してください。部分的な情報や関連する情報も含めて、可能な限り多くの従業員を表示してください。
